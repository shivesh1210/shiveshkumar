---
layout: page
title: Swinging Pendulums on the Cloud
description: Digitizing Experimental Infrastructure for Instant Feedback based Learning
...
<div class="row">
    ...
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/ff_experiment.jpeg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/live_camera.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
